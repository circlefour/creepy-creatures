# 𝔠𝔯𝔢𝔢𝔭𝔶 𝔠𝔯𝔢𝔞𝔱𝔲𝔯𝔢𝔰 : 𝔟𝔲𝔦𝔩𝔡 𝔞 𝔣𝔞𝔠𝔢 𝔱𝔯𝔞𝔠𝔨𝔦𝔫𝔤 𝔯𝔬𝔟𝔬𝔱
...
## 𝔩𝔦𝔫𝔨 𝔱𝔬 𝔱𝔥𝔢 𝔣𝔞𝔠𝔢 𝔱𝔯𝔞𝔠𝔨𝔦𝔫𝔤 𝔴𝔢𝔟𝔭𝔞𝔤𝔢
...
### link to a webpage that only triggers the onboard LED
[led trigger](https://arduino-led-serial.vercel.app)
